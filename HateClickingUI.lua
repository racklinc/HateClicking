...
HCMLMovingDefaultStr:SetPoint("TOPLEFT", 185, -85)
...
local HCHelpTitle = panel:CreateFontString(nil,"ARTWORK","GameFontNormalLarge")
HCHelpTitle:SetPoint("TOPLEFT",10,-240)
HCHelpTitle:SetText("HateClicking: Help")
local HCHelpText = panel:CreateFontString(nil,"ARTWORK","GameFontNormalLeftGrey")
HCHelpText:SetPoint("TOPLEFT",10,-260)
HCHelpText:SetText("Several of this addons features are done through the keybindings menu.\nFrom the games Main Menu GoTo Keybindings -> Addons -> HateClicking and set keybindings there.\n\nIt is also reccomended to set the Blizzard binding (Target Scan Enemy) as a keybinding.")
local HCMoreToComeTitle = panel:CreateFontString(nil,"ARTWORK", "GameFontNormalLarge")
HCMoreToComeTitle:SetPoint("TOPLEFT",10,-385)
HCMoreToComeTitle:SetText("HateClicking: More to come...")
local HCMoreToComeText = panel:CreateFontString(nil,"ARTWORK","GameFontNormalLeftGrey")
HCMoreToComeText:SetPoint("TOPLEFT",10,-410)
HCMoreToComeText:SetText("Context keybindings that will adapt to conditions such as raidmarking, NPC gossip progress, quest reward selection.\nKeybinding to handle using usable quest items.\nEngineering enthusiast macro replacements\nKeybindings to use common items such as Healthstones, health potions, combat potions, trinkets.\nContext of Accept Rez and cast a rez")
